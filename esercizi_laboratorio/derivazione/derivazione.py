...
graph_main.plot( ascisse[:-2],  derivataOrdineh1, linestyle="--", color="g" ,label=str(r'$\mathcal:O(h)$') )
graph_main.plot( ascisse[1:-2], derivataOrdineh2, linestyle="--", color="r" ,label=str(r'$\mathcal:O(h^2)$') )
graph_main.plot( ascisse[3:-2], derivataOrdineh4, linestyle="--", color="m" ,label=str(r'$\mathcal:O(h^4)$') )
